...
import 'package:block_break/gameover_view.dart';
import 'package:block_break/initial_view.dart';
...
class GameLoop extends FlameGame
  ...
  void onMount() {
    paused = true;
    addGameStateListener(onOverlayChanged);
    super.onMount();
  }
